...
ajax.transit.transit_type = (function ajax$transit$transit_type(p__22008){
var map__22009 = p__22008;
var map__22009__$1 = (((((!((map__22009 == null))))?(((((map__22009.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22009.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22009):map__22009);
var type = cljs.core.get.call(null,map__22009__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var writer = (function (){var or__4131__auto__ = new cljs.core.Keyword(null,"writer","writer",-277568236).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"write","write",-1857649168),ajax.transit.transit_write_fn.call(null,type,request),new cljs.core.Keyword(null,"content-type","content-type",-508222634),["application/transit+",mime_type].join('')], null);
});
...
var reader = (function (){var or__4131__auto__ = new cljs.core.Keyword(null,"reader","reader",169660853).cljs$core$IFn$_invoke$arity$1(request);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
//# sourceMappingURL=transit.js.map?rel=1561537537061
