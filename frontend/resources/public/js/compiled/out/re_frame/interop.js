...
return [(function (){var pred__21430 = cljs.core.instance_QMARK_;
var expr__21431 = reactive_val;
if(cljs.core.truth_(pred__21430.call(null,reagent.ratom.RAtom,expr__21431))){
return "ra";
} else {
if(cljs.core.truth_(pred__21430.call(null,reagent.ratom.RCursor,expr__21431))){
return "rc";
} else {
if(cljs.core.truth_(pred__21430.call(null,reagent.ratom.Reaction,expr__21431))){
return "rx";
} else {
if(cljs.core.truth_(pred__21430.call(null,reagent.ratom.Track,expr__21431))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1561537536369
