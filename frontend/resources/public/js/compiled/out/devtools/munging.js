...
var o24065 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24065["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24066 = temp__5733__auto____$1;
return (o24066["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23175__auto__ = f;
return (o__23175__auto__["toString"]).call(o__23175__auto__);
} else {
return "";
}
}catch (e24067){var _ = e24067;
return "";
}});
...
try{var o__23175__auto___24069 = t;
(o__23175__auto___24069["cljs$lang$ctorPrWriter"]).call(o__23175__auto___24069,t,writer);
}catch (e24068){var __24070 = e24068;
}
...
var char_code = (function (){var o__23175__auto__ = (new String(char$));
return (o__23175__auto__["charCodeAt"]).call(o__23175__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23175__auto__ = String;
return (o__23175__auto__["fromCharCode"]).call(o__23175__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24071 = num_code;
switch (G__24071) {
case (1):
return (185);
...
var o__23175__auto__ = String;
return (o__23175__auto__["fromCharCode"]).call(o__23175__auto__,superscript_code);
});
/**
...
}catch (e24073){var _e__23182__auto__ = e24073;
return false;
}})())){
...
var vec__24074 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24074,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o24077 = temp__5733__auto__;
var temp__5733__auto____$1 = (o24077["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o24078 = temp__5733__auto____$1;
return (o24078["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24081){
var vec__24082 = p__24081;
var ns_detector = cljs.core.nth.call(null,vec__24082,(0),null);
...
var G__24088 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24089 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24088;
remaining_tokens = G__24089;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24079){
...
var vec__24093 = cljs.core.split_with.call(null,(function (p1__24092_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24092_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24093,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24093,(1),null);
...
var vec__24099 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24099,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24099,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24102 = cljs.core.rest.call(null,remaining_tokens);
var G__24103 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24102;
name_tokens = G__24103;
continue;
} else {
...
var vec__24106 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24106,(0),null);
var arity = cljs.core.nth.call(null,vec__24106,(1),null);
var vec__24109 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24109,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24109,(1),null);
var vec__24112 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24112,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24112,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24112,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24112,(3),null);
...
var vec__24118 = result;
var munged_ns = cljs.core.nth.call(null,vec__24118,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24118,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24118,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24118,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24118,(4),null);
var arity = cljs.core.nth.call(null,vec__24118,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__24122 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__24122,(0),null);
var args = cljs.core.nth.call(null,vec__24122,(1),null);
var vec__24125 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24125,(0),null);
var name = cljs.core.nth.call(null,vec__24125,(1),null);
...
var G__24128 = (arity + (1));
var G__24129 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24130){
var vec__24131 = p__24130;
var arity = cljs.core.nth.call(null,vec__24131,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24131,(1),null);
...
return cljs.core.get.call(null,arities,p1__24134_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24135_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24138){
var vec__24139 = p__24138;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24139,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24136){
var G__24137 = cljs.core.first.call(null,seq24136);
var seq24136__$1 = cljs.core.next.call(null,seq24136);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24137,seq24136__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24147__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24147__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24147__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24147__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24148 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24148,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24148,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24148,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24148,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24148,(4),null);
var arity = cljs.core.nth.call(null,vec__24148,(5),null);
...
var o__23175__auto__ = f;
return (o__23175__auto__["getBasis"]).call(o__23175__auto__);
});
/**
...
}catch (e24152){var _e__23182__auto__ = e24152;
...
var G__24153 = (obj[cljs.core.first.call(null,path)]);
var G__24154 = cljs.core.rest.call(null,path);
obj = G__24153;
path = G__24154;
continue;
} else {
...
return (function (accum,p__24155){
var vec__24156 = p__24155;
var bit = cljs.core.nth.call(null,vec__24156,(0),null);
var protocol = cljs.core.nth.call(null,vec__24156,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24159){
var vec__24160 = p__24159;
var ns = cljs.core.nth.call(null,vec__24160,(0),null);
var name = cljs.core.nth.call(null,vec__24160,(1),null);
var selector = cljs.core.nth.call(null,vec__24160,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24165,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24165,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24165,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24163_SHARP_){
return (obj[cljs.core.first.call(null,p1__24163_SHARP_)]);
});})(name,sorted_matches,vec__24165,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1561537539445
