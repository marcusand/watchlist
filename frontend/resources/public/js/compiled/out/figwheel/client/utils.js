...
return (new CustomEvent(event_name,(function (){var obj30051 = ({"detail":data});
return obj30051;
})()));
} else {
...
var f = (function (){var pred__30058 = cljs.core._EQ_;
var expr__30059 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__30058.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__30059))){
return ((function (pred__30058,expr__30059){
return (function (p1__30052_SHARP_){
return console.warn(p1__30052_SHARP_);
});
;})(pred__30058,expr__30059))
} else {
if(cljs.core.truth_(pred__30058.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__30059))){
return ((function (pred__30058,expr__30059){
return (function (p1__30053_SHARP_){
return console.debug(p1__30053_SHARP_);
});
;})(pred__30058,expr__30059))
} else {
if(cljs.core.truth_(pred__30058.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__30059))){
return ((function (pred__30058,expr__30059){
return (function (p1__30054_SHARP_){
return console.error(p1__30054_SHARP_);
});
;})(pred__30058,expr__30059))
} else {
return ((function (pred__30058,expr__30059){
return (function (p1__30055_SHARP_){
return console.log(p1__30055_SHARP_);
});
;})(pred__30058,expr__30059))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__30062){
...
var opts = map__30063__$1;
var eval_fn = cljs.core.get.call(null,map__30063__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__30065_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__30067,(0),null);
...
}catch (e30072){if((e30072 instanceof Error)){
var e = e30072;
return not_found;
} else {
throw e30072;
...
//# sourceMappingURL=utils.js.map?rel=1561537545174
